...
class CreateTasksTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection(pWfmDBConnectionName())->create('tasks', function($table){
            ...
            $table->integer('restart_status', false)->default(0);
    ...
    {
        Schema::connection(pWfmDBConnectionName())->dropIfExists('tasks');
    }
}
