...
class CreateTaskWorkforcesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection(pWfmDBConnectionName())->create('task_workforces', function ($table) {
            $table->increments('id');
            $table->integer('task_id' ,false)->unsigned()->nullable();
            $table->integer('workforcer_id',false)->unsigned()->nullable();
            ...
            $table->foreign('workforcer_id')->references('id')->on(pCommonDBName() . '.hrm_employees')->onUpdate('cascade')->onDelete('cascade');
    ...
    public function down()
    {
        ...
        Schema::connection(pWfmDBConnectionName())->dropIfExists('task_workforces');
    }
}
